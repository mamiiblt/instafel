...
import dev.mamii.instafel.updater.BuildConfig;
...
public class SettingsFragment extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, @Nullable String rootKey) {
        ...
        appVersion.setSummary(getActivity().getString(R.string.app_version_s, BuildConfig.IFLU_VERSION, BuildConfig.COMMIT));
    ...
    private void showPreferenceDialog(ListPreference preference) {
        DialogFragment dialogFragment = new dev.mamii.instafel.updater.utils.MaterialListPreference();
