...
import {ChevronRight, FileCog2Icon, FileSpreadsheet} from "lucide-react";
                ...
                {data ? (
                    <Page
                        ...
                        content={<>
                            ...
                            >
                                <div
                                    className="bg-white dark:bg-gray-800/50 rounded-xl shadow-md overflow-hidden border-2 mb-8">
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <div className="flex items-start">
                                                            <div
                                                                className="bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 p-3 rounded-lg mr-4">
