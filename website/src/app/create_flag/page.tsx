...
import ImageUploadInterface, {UploadedFile,} from "@/components/ImageUploadInterface";
                        ...
                        >
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                              ...
                              {lastEdit.toLocaleString()}
                                                        ...
                                                        {fUploadData.uploading ? (
                                                            <>
                                                                {fUploadData.name == "error" ? (
                                                                    <div className="space-y-2">
                                                                        <div
                                                                            className="items-center justify-center text-center p-4 bg-card-50 border rounded-lg ">
                                ...
                                <Card
                                    className="shadow-lg border-0 bg-gradient-to-r from-primary/5 to-primary/10 border-primary/20">
