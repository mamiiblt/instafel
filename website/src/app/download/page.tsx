            ...
            <AnimatePresence>
                {loading ? (
                    ...
                    <div className="min-h-screen flex flex-col bg-background">
                        <div
                            className="container mx-auto px-2 sm:px-4 md:px-8 pt-8 sm:pt-12 md:pt-16 lg:pt-20 pb-32 sm:pb-12 flex-grow">
                            <motion.div
                            ...
                            {data && (
                                ...
                                >
                                    {variants.map((variant) => (
                                        ...
                                        >
                                            <Card
                                                className="h-full border-2 hover:border-primary/70 transition-all duration-300 overflow-hidden shadow-lg bg-card/80">
                                                <CardContent className="p-0">
                                                    <div className="p-4 sm:p-6 pb-0">
                                                        <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
                                                            <div
                                                                className="p-2 sm:p-3 rounded-full bg-gradient-to-r from-primary/20 to-primary/5">
                                                                {variant.icon}
                                                            </div>
                                                            <div>
                                                    ...
                                                    <div className="px-4 sm:px-6 pb-3 sm:pb-4">
                                                        <h4 className="text-xs sm:text-sm font-medium mb-2 flex items-center">
                                                            <CheckCircle
                                                                className="h-3.5 w-3.5 sm:h-4 sm:w-4 mr-1.5 text-primary"/>
                                                            {t("common.benefits")}
                                                        </h4>
                                                        <ul className="space-y-0.5 sm:space-y-1 mb-5 sm:mb-6">
                                                            {variant.benefits.map((benefit, benefitIndex) => (
                                                                ...
                                                                >
                                                                    <ChevronRight
                                                                        className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-primary/70 mr-1"/>
                                                                    {benefit}
                                                                </li>
                                                            ))}
                                                        </ul>
                                                    ...
                                                    <div
                                                        className="bg-gradient-to-r from-primary/5 to-primary/10 p-4 sm:p-6">
                                                        <Button
                                                            size="default"
                                                ...
                                                <div className="p-4 sm:p-5 md:p-6">
                                                    <TabsContent value="changelog" className="mt-0">
                                                        ...
                                                        {data.changelogs && data.changelogs.length > 0 ? (
                                                            <div
                                                                className="space-y-1 max-h-[320px] overflow-y-auto pr-2 custom-scrollbar">
                                                                {data.changelogs.map((item, idx) => (
                                                                    ...
                                                                    >
                                                                        <div
                                                                            className="flex group items-start gap-2 py-2 px-3 hover:bg-muted/40 rounded-md transition-colors">
                                                                            <ChevronRight
                                                                                className="h-4 w-4 shrink-0 text-primary mt-0.5 group-hover:translate-x-0.5 transition-transform"/>
                                                                            <span
                                                                                className="text-sm group-hover:text-foreground/90 transition-colors">
                                        {item}
                                      </span>
                                                                        </div>
                                                                    </motion.div>
                                                    ...
                                                    <TabsContent value="build" className="mt-0">
                                                        ...
                                                        <div
                                                            className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4 pt-4 border-t">
                                                            <div className="bg-muted/30 rounded-lg p-3">
                                                                ...
                                                                <code
                                                                    className="text-xs block bg-background/80 p-2 rounded overflow-x-auto whitespace-nowrap">
                            ...
                            {!data && !loading && (
                                <div className="text-center p-4 xs:p-6 sm:p-10 md:p-12 border rounded-lg bg-card/90">
                                    <FileText
                                        className="mx-auto h-12 w-12 sm:h-16 sm:w-16 text-muted-foreground mb-3 sm:mb-4 opacity-50"/>
